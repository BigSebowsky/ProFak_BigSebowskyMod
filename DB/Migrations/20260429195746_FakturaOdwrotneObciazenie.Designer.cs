...
namespace ProFak.DB.Migrations
{
    ...
    [Migration("20260429195746_FakturaOdwrotneObciazenie")]
    partial class FakturaOdwrotneObciazenie
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProFak.DB.Faktura", b =>
                {
                    ...
                    b.Property<bool>("CzyOdwrotneObciazenie")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("ProFak.DB.KSeFZakupInbox", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<bool>("CzyNowa")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(true);

                    b.Property<DateTime?>("DataDodaniaJakoZakup")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<DateTime?>("DataRozliczenia")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("KSeFZakupInbox", (string)null);
                });

            modelBuilder.Entity("ProFak.DB.KSeFZakupInboxStan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<bool>("CzyAutoSynchronizacja")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(true);

                    b.Property<DateTime?>("DataNastepnejSynchronizacji")
                        .HasColumnType("TEXT");

                    b.Property<DateTime?>("DataOstatniejSynchronizacji")
                        .HasColumnType("TEXT");

                    b.Property<DateTime>("DataPoczatkowaSynchronizacji")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2026, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified));

                    b.Property<int>("InterwalSynchronizacjiMinuty")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(15);

                    b.Property<int>("LiczbaNowychDokumentow")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(0);
                    ...
                    b.ToTable("KSeFZakupInboxStan", (string)null);
                });
            ...
            modelBuilder.Entity("ProFak.DB.Konfiguracja", b =>
                {
                    ...
                    b.Property<bool>("WysylajPlatnoscDoKSeF")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("ProFak.DB.Kraj", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<bool>("CzyUE")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(false);

                    b.Property<string>("KodISO2")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue("");
            ...
            modelBuilder.Entity("ProFak.DB.RachunekBankowy", b =>
                {
                    ...
                    b.Property<string>("NumerEksportowy")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue("");
